...
int main(int argc, char const *argv[])
{
	...
	if(init_sdl()) {
		...
		double points_cardinaux[][3] = {{0,0,rayon},{0,0,-rayon},{rayon,0,0},
		{-rayon,0,0},{0,rayon,0},{0,-rayon,0}};
		ajout_points_xyz(&prisme, points_cardinaux, 6);
		int aretes_prisme[][2] = {{1,2},{1,3},{1,4},{1,5},{0,2},{0,3},{0,4},
		{0,5},{2,4},{4,3},{3,5},{5,2}};
		ajout_aretes_i(&prisme, aretes_prisme, 12);


		//0-3base, 4sommet
		double points_pyramide[][3] = {{100,-100,100},{100,100,100},
